...
console.log(state)
const data=(details)=>{
  axios.post(`https://insta-shop.onrender.com/${details}`,{
...
const deleteData=(id)=>{
  axios.delete(`https://insta-shop.onrender.com/jewelry/${id}`)
}

const viewData=(id)=>{
  axios.get(`https://insta-shop.onrender.com/earrings/${id}`)
